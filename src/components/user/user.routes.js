...
router.get('/confirm/:token', asyncErrorHandler(users.confirmEmail))
router.get('/logout', auth([roles.user]), validation(Val.NoDataSchema), asyncErrorHandler(users.logOut))
